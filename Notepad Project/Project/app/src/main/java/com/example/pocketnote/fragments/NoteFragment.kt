...
import com.example.pocketnote.adapters.RvNotesAdapter
import com.example.pocketnote.databinding.FragmentNoteBinding
import com.example.pocketnote.model.Note
import com.example.pocketnote.utils.SwipeToDelete
...
class NoteFragment : Fragment(R.layout.fragment_note) {
    ...
    private fun swipeToDelete(rvNote: RecyclerView) {
        ...
        val swipeToDelegateCompat=object : SwipeToDelete()
        {
        ...
        val itemTouchHelper=ItemTouchHelper(swipeToDelegateCompat)
